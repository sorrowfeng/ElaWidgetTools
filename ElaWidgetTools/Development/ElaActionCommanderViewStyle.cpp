        ...
        if (const QStyleOptionViewItem* vopt = qstyleoption_cast<const QStyleOptionViewItem*>(option))
        {
            ...
            if (indexNode && indexNode->getIsCommandNode())
            {
                ...
                case ElaMessageBarType::Success:
                {
                    ...
                    painter->drawText(textRect.x() - 5, textRect.y(), textRect.width(), textRect.height(), Qt::AlignVCenter | Qt::AlignLeft, QChar((unsigned short)ElaIconType::Check));
                    break;
                }
                ...
                case ElaMessageBarType::Error:
                {
                    ...
                    painter->drawText(textRect.x() - 5, textRect.y(), textRect.width(), textRect.height(), Qt::AlignVCenter | Qt::AlignLeft, QChar((unsigned short)ElaIconType::Xmark));
                    break;
                }
                default:
                {
