...
QColor ElaColorDialog::getColor(const QColor& initial, QWidget* parent, const QString& title)
{
	QScopedPointer<ElaColorDialog> dlg(new ElaColorDialog(parent));
	if (!title.isEmpty())
