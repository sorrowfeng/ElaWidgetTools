...
void MainWindow::initEdgeLayout()
{
	...
	ElaToolButton* toolButton13 = new ElaToolButton(this);
	toolButton13->setElaIcon(ElaIconType::InputText);
	toolBar->addWidget(toolButton13);
	...
	connect(toolButton13, &QToolButton::clicked, this, [=]() {
		auto text = ElaInputDialog::getText(this, "输入窗口", "请输入你的名字");
		if (!text.isEmpty())
			ElaMessageBar::success(ElaMessageBarType::BottomRight, "你输入了", text, 2000);
		});
}
